...
- For yolov5 v6.1, download .pt from [yolov5 release v6.1](https://github.com/ultralytics/yolov5/releases/tag/v6.1), `git clone -b v6.1 https://github.com/ultralytics/yolov5.git` and `git clone -b yolov5-v6.1 https://github.com/wang-xinyu/tensorrtx.git`, then follow how-to-run in current page.
